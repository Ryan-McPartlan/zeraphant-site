  ...
  return (
    <main className="relative min-h-dvh overflow-hidden px-6 py-24 sm:px-12 lg:px-20">
      <div className="relative z-20 max-w-xl">
        <h1 className="font-fire animate-text-on-fire text-6xl leading-[0.95] tracking-wide sm:text-8xl">
          Passion
        </h1>
        <p className="font-fire animate-text-on-fire mt-5 text-xl tracking-wide sm:text-2xl">
